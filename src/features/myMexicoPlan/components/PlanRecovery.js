...
const CONTENT = {
  en: {
    ...
    seoDescription: "Your personalized 365-day relocation roadmap, built from your Blueprint answers.",
    eyebrow: "My Mexico Plan",
    invalidCityTitle: "We couldn't find that destination.",
    noBlueprintTitle: "This plan needs your Blueprint first.",
    invalidCityText: "That link doesn't match a destination we currently cover. Your Mexico Plan is personalized to a specific place, built from your own Blueprint answers — start there and we'll take it from here.",
    noBlueprintText: "My Mexico Plan is a personalized 365-day roadmap, built entirely from your own Blueprint answers. Complete your Blueprint — it takes a few minutes — and we'll build your plan from what you tell us.",
    startBlueprint: "Start My Mexico Blueprint",
    returnToYourMexico: "Return To Your Mexico",
    backLabel: "Back To Your Mexico",
  },
  es: {
    seoTitle: "My Mexico Plan",
    seoDescription: "Tu hoja de ruta personalizada de reubicación a 365 días, construida a partir de tus respuestas del Blueprint.",
    eyebrow: "My Mexico Plan",
    invalidCityTitle: "No pudimos encontrar ese destino.",
    noBlueprintTitle: "Este plan necesita primero tu Blueprint.",
    invalidCityText: "Ese enlace no coincide con un destino que cubramos actualmente. Tu Mexico Plan está personalizado para un lugar específico, construido a partir de tus propias respuestas del Blueprint — empieza ahí y nosotros nos encargamos del resto.",
    noBlueprintText: "My Mexico Plan es una hoja de ruta personalizada de 365 días, construida enteramente a partir de tus propias respuestas del Blueprint. Completa tu Blueprint — toma unos minutos — y construiremos tu plan a partir de lo que nos cuentes.",
    startBlueprint: "Empezar Mi Mexico Blueprint",
    returnToYourMexico: "Volver A Your Mexico",
...
export default function PlanRecovery({ variant, cityId, lang = "en" }) {
  ...
  return (
    <YourMexicoShell backTo="/your-mexico" backLabel={t.backLabel} lang={lang}>
      ...
      <h1 className="mt-4 max-w-2xl text-4xl font-light leading-tight tracking-[-0.03em] sm:text-5xl">
        {isInvalidCity ? t.invalidCityTitle : t.noBlueprintTitle}
      </h1>

      <p className="mt-6 max-w-xl text-lg leading-relaxed text-zinc-600">
        {isInvalidCity ? t.invalidCityText : t.noBlueprintText}
      </p>
