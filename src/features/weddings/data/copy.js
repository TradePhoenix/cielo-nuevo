...
export const WEDDINGS_CONTENT = {
  en: {
    ...
    inquiry: {
      ...
      submitting: "Sending…",
      formError: "Something went wrong while sending your inquiry. Your details are still here — please try again.",
      submit: "Send Inquiry",
  ...
  es: {
    ...
    inquiry: {
      ...
      submitting: "Enviando…",
      formError: "Algo salió mal al enviar tu consulta. Tus datos siguen aquí — inténtalo de nuevo.",
