...
const TEXT = {
  en: {
    prefix: (name) => `Already feel good about ${name}?`,
    cta: "Book Your Mexico Fit Call",
    suffix: "— or keep exploring below.",
  },
  es: {
    prefix: (name) => `¿Ya te convenció ${name}?`,
    cta: "Agenda Tu Llamada De Compatibilidad",
    suffix: "— o sigue explorando abajo.",
  },
};
...
export default function MidPageCTA({ cityName, cityId, lang = "en" }) {
