  ...
  en: {
    ...
    services: [
      ...
      },
      {
        ...
        price: "$499 USD",
        text: "A personalized relocation plan built around your timeline, budget, lifestyle preferences, housing needs, and long-term vision for life in Mexico.",
        bestFor: ["People ready to plan", "Couples and families", "Remote workers", "Retirees", "Entrepreneurs"],
        cta: "Explore The Roadmap",
        href: "/relocation-roadmap",
      },
      {
        ...
        bestFor: ["Hands-on support", "Local connections", "Housing coordination", "Professional introductions", "Ongoing guidance"],
        cta: "Explore Guided Landing",
        href: "/guided-landing",
      },
    ],
  ...
  es: {
    ...
    services: [
      ...
      },
      {
        ...
        price: "$499 USD",
        text: "Un plan personalizado de reubicación construido alrededor de tu cronograma, presupuesto, preferencias de estilo de vida, necesidades de vivienda y visión a largo plazo en México.",
        bestFor: ["Personas listas para planear", "Parejas y familias", "Trabajadores remotos", "Jubilados", "Emprendedores"],
        cta: "Explorar El Roadmap",
        href: "/relocation-roadmap",
      },
      {
        ...
        bestFor: ["Apoyo práctico", "Conexiones locales", "Coordinación de vivienda", "Presentaciones profesionales", "Acompañamiento continuo"],
        cta: "Explorar Llegada Guiada",
        href: "/guided-landing",
      },
    ],
